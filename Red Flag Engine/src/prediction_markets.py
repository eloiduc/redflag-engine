...
# Used in two places: (1) building the Polymarket/Kalshi search query string,
# and (2) the hard-filter that requires the company name or ticker to appear
# literally in the market question.  Missing entries cause ALL markets for
# that company to be excluded by the hard-filter (e.g. "PYPL" ≠ "paypal").
